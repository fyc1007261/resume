...
\basicInfo{
  ...
  \linkedin[billryan8]{https://www.linkedin.com/in/yifan-cai-681485155/}}
...
\{Individual Project}
Designed a B+ tree based database system. The system supports CRUD operations. 
\begin{itemize}
  \item Written in C++
...
\datedline{\textit{\nth{3} Prize}, SJTU Scholarships}{2016 - 2017}


\section{\faInfo\ Miscellaneous}
\begin{itemize}[parsep=0.5ex]
  \item GitHub: https://github.com/fyc1007261
